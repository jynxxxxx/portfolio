...
export function Contact({ id }: { id: string }) {
  const handleCopy = () => {
    navigator.clipboard.writeText("jnykim97@gmail.com");
        ...
        <div className="text-center">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 shadow-elevated max-w-2xl mx-auto">
            ...
            <div className="space-y-4 mb-8">
              <div className="relative inline-block w-full rounded-3xl mb-6 p-[2px] bg-gradient-primary transition-all hover:p-[4px]">
                <button
                  onClick={handleCopy}
                  className="group flex justify-center items-center gap-2 w-full rounded-3xl py-1 bg-black"
                >
                  <Mail className="w-5 h-5 mr-3 transition-transform group-hover:scale-110" />
                  jnykim97@gmail.com
                  <Copy className="w-4 h-4 ml-3 transition-transform group-hover:translate-x-1" />
                </button>
              </div>

              <div className="relative inline-block w-full rounded-3xl mb-6 p-[2px] bg-gradient-secondary transition-all hover:p-[4px]">
                <a 
              ...
              <div className="relative inline-block w-full rounded-3xl mb-6 p-[2px] bg-gradient-tertiary transition-all hover:p-[4px]">
                <a 
                  href="https://www.linkedin.com/in/jnykim/" 
                  target="_blank" rel="noopener noreferrer" 
                  className="flex justify-center items-center gap-2 w-full group rounded-3xl py-1 bg-black"
                >
